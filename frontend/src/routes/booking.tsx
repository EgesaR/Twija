...
const LeftInfo = () => (
  <div className='relative lg:w-[40%] min-h-[40vh] lg:min-h-screen overflow-hidden'>
    <div
        ...
        <form onSubmit={onSubmit} className='space-y-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <FormField label='Full Name'>
              <Input {...register('fullName')} placeholder='Jane Cooper' />
              {errors.fullName && (
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <FormField label='Select Your Tour'>
              <Select {...register('tour')}>
                <SelectTrigger className='h-12 border-0 border-b-2 border-slate-200 rounded-none px-0 text-lg focus:ring-0 focus:border-green-700 shadow-none bg-transparent'>
                ...
                render={({ field }) => (
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant='outline'
                        className='w-full h-12 justify-start border-0 border-b-2 border-slate-200 rounded-none px-0 text-lg font-normal hover:bg-transparent hover:border-green-700 focus:border-green-700 bg-transparent shadow-none'
                      >
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <FormField label='Participants'>
              <div className='flex items-center gap-4 border-b-2 border-slate-200 h-12'>
          ...
          <div className='pt-8'>
            <Button
              ...
              className='w-full bg-slate-900 hover:bg-green-700 text-white rounded-full text-lg font-medium transition-all duration-500 shadow-2xl shadow-slate-200 group py-1! h-12!'
            >
              {isSubmitting ? (
...
const FormField = ({ label, children }: FormFieldProps) => (
  <div className='input-anim space-y-2 group'>
    <Label className='text-[10px] uppercase tracking-widest font-bold text-slate-400 group-focus-within:text-green-700'>
      {label}
    </Label>
    {children}
  </div>
